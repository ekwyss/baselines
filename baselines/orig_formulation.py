...
if __name__ == '__main__':
	checkpoints = [Checkpoint(sample_sg_0,achieved_sg0,achieved_goal_sg_0,0,0.0),Checkpoint(sample_sg_1,achieved_sg1,achieved_goal_sg_1,1,0.0),Checkpoint(sample_sg_2,achieved_sg2,achieved_goal_sg_2,2,0.0)]
